<!doctype html>
  <html class="no-js"  <?php language_attributes(); ?>>
	<head>
		...
		<!-- Font Awesome -->
		<script src="https://kit.fontawesome.com/78ff2f54a9.js?v=1.1.2" crossorigin="anonymous"></script>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=G-CJ6NPN4BQ6"></script>
		<script>
			window.dataLayer = window.dataLayer || [];
			function gtag(){dataLayer.push(arguments);}
			gtag('js', new Date());

			gtag('config', 'G-CJ6NPN4BQ6');
		</script>
